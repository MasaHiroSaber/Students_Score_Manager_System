...
class TMainWindow(FramelessWindow):
    ...
    def __init__(self):
        ...
        self.infoTeachers = InfoTeachers(self)
        self.entryGrades = EntryGrades(self)
    ...
    def initNavigation(self):
        ...
        self.addSubInterface(self.infoTeachers, 'infoTeachers', FIF.INFO, self.tr('教师信息'))
        self.addSubInterface(self.entryGrades, 'entryGrades', FIF.EDIT, self.tr('成绩录入'))
        self.addSubInterface(self.infoAccount, 'infoAccount', FIF.MORE, self.tr('账户信息'))
